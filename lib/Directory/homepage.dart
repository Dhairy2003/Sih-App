...
import 'package:sih2/Directory/detailPage.dart';
import 'package:sih2/svg_icnbtn.dart';

class list_mkr extends StatefulWidget {
  final MediaQueryData qd;
   list_mkr({required this.qd, Key? key}) : super(key: key);

  @override
  State<list_mkr> createState() => _list_mkrState();
}

class _list_mkrState extends State<list_mkr> {
  final List<Map<String, dynamic>> _allWords = [
    {'id': 1, 'name': 'Blast', 'mean': 'disease found in rice',
     'desc': """"'India is the world\'s second-largest producer of rice, and the largest exporter of rice in the world. Rice is one of the chief grains of India. Moreover, this country has the largest area under rice cultivation. As it is one of the principal food crops, it is the dominant crop of the country. Rice is the basic food crop and being a tropical plant, it flourishes comfortably in a hot and humid climate. Rice is mainly grown in rain-fed areas that receive heavy annual rainfall, making it a kharif crop in India. It demands a temperature of around 25 degrees Celsius and above, and rainfall of more than 100 cm (39 in). Rice is also grown through irrigation in those areas that receive less rainfall.\n\n'
'Suitable Temperature:\n\n'
'Rice is a tropical crop and grown where the average temperature during the growing season is between 20°C and 27°C. Abundant sunshine is essential during its four months of growth. The minimum temperature should not go below 15°C as germination cannot take place below that temperature. Paddy requires more water than any other crop. As a result, paddy cultivation is done only in those areas where the minimum rainfall is 115 cm. Regions with average annual rainfall between 175—300 cm are the most suitable for rice cultivation.'
"""
    ...
    },
    {
      'id': 2,
      'name': 'leaf blight',
      'mean': 'disease found in paddy'
    },
    {'id': 3, 'name': 'Potato Rust', 'mean': 'disease found in potato'},
    {
      'id': 4,
      'name': 'Abscond',
            ...
            children: [
              Container(
                ...
                padding: EdgeInsets.symmetric(
                    horizontal: widget.qd.size.width * 0.02),
                      ...
                      return GestureDetector(
                        onTap: () {
                          Navigator.of(context).push(
                            MaterialPageRoute(
                              builder: (context) => DetailPage(word: _foundWords[index]),
                            ),
                          );
                        },
                        ...
                        child: ClipRRect(
                          ...
                          child: Card(
                            ...
                            child: ListTile(
                              leading: SvgIconButton(iconPath: 'images/Question mark.svg', onPressed: () {  },iconColor: Colors.green,),
                              title: Text(
